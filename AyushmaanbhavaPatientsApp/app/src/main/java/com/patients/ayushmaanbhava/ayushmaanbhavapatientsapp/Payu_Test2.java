...
public class Payu_Test2 extends AppCompatActivity {
    ...
    */
    ...
    // Final Variables
    String datee, appoint_type, visit_type,a_get, namee, email, number, id,did,reason,appoint_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = ProgressDialog.show(Payu_Test2.this, "Showing ProgressDialog", "Loading...");
        /**
...
*/
        ...
        appoint_id = bundle.getStringExtra("appointmentid");
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(Payu_Test2.this);
...
*/
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (url.equals(mSuccessUrl)) {
                    ...
                    Intent intent = new Intent(Payu_Test2.this, PaymentStatusActivity2.class);
        ...
        webView.addJavascriptInterface(new PayUJavaScriptInterface(Payu_Test2.this), "PayUMoney");
    ...
    public class PayUJavaScriptInterface {
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    mHandler = null;
                    Toast.makeText(Payu_Test2.this, "Payment Successfully.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
