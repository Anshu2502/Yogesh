...
public class Payu_Test extends AppCompatActivity {
    ...
    */
    ...
    String datee, appoint_type, visit_type,a_get, namee, email, number, id,did,reason;
    private String mMerchantKey = "xIOy8M";
    private String mSalt = "qKkvpwzI";
    private String mBaseURL = "https://secure.payu.in";//"https://test.payu.in";//
    ...
    private String mProductInfo = "Appointment Payment"; //Passing String only
    ...
    private String mFailedUrl = "https://payu.herokuapp.com/failure";//"Your Failure URL";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = ProgressDialog.show(Payu_Test.this, "Showing ProgressDialog", "Loading...");
        /**
     ...
     //   Bundle bundle = getIntent().getExtras();
       // if (bundle != null) {
            ...
            Intent bundle = getIntent();
               a_get = bundle.getStringExtra("amount");
               namee = bundle.getStringExtra("names");
               email = bundle.getStringExtra("mail");
               number = bundle.getStringExtra("number");
               id = bundle.getStringExtra("id");
               datee = bundle.getStringExtra("a_date");
               appoint_type = bundle.getStringExtra("appoint_type");
               visit_type = bundle.getStringExtra("v_type");
               reason = bundle.getStringExtra("visit_reason");
               did = bundle.getStringExtra("doc_id");



            mFirstName = namee;//bundle.getString("name");
            mEmailId = email;//bundle.getString("email");
            mAmount = Float.parseFloat(a_get);//Integer.parseInt(get);//bundle.getDouble("amount");
            mPhone = number;//bundle.getString("phone");
            mId = Integer.parseInt(id);//bundle.getInt("id");
            isFromOrder = true;//bundle.getBoolean("isFromOrder");



            Log.i("<<<>>>", "" + mFirstName + " : " + mEmailId + " : " + mAmount + " : " + mPhone);
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                    final AlertDialog.Builder builder = new AlertDialog.Builder(Payu_Test.this);
...
*/
                ...
                public void onPageFinished(WebView view, String url) {
                    progressBar.dismiss();
                    Log.e("<<URL>>>",url);
                    //  namee, email,number,date,appoint_type,visit_type,reason
                    if (url.equals(mSuccessUrl)) {
                        Toast.makeText(activity, "Success", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(Payu_Test.this, PaymentStatusActivity.class);
                        ...
                        intent.putExtra("a_type",appoint_type);
                        intent.putExtra("v_type",visit_type);
            ...
            webView.addJavascriptInterface(new PayUJavaScriptInterface(Payu_Test.this), "PayUMoney");
    ...
    public class PayUJavaScriptInterface {
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    mHandler = null;
                    Toast.makeText(Payu_Test.this, "Payment Successfully.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
