...
public class Pro_Adapter3 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Pro_Adapter3(Context context, List<Pro_Cons> data){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ((MyHolder) holder).details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Pro_Cons current=data.get(position);
                Intent intent = new Intent(context,Prescription_detail_more.class);
