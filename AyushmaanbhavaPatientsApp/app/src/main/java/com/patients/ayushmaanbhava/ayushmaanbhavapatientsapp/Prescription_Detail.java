...
public class Prescription_Detail extends AppCompatActivity {
    String type,visit_types,doc,number,user_name,doc_id,datee,user_id,user_imgname,patient_id;
    private DrawerLayout drawerLayout;
    private Toolbar toolbar;
    int loader = R.mipmap.patient;
    private RecyclerView mRVFishPrice;
    private Pro_Adapter3 mAdapter;
    int appoint = 0;
    ...
    public void get_user_data(){
        final ProgressDialog loading = ProgressDialog.show(Prescription_Detail.this, "Please Wait", "Getting Profile Information", false, false);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://ayushmaanbhavahealingcenter.com/admin/app/get_user_profile.php",
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Prescription_Detail.this,error.toString(),Toast.LENGTH_LONG ).show();
                    }
                }){
            @Override
    ...
    public void get_appoint_list(){
        final ProgressDialog loading = ProgressDialog.show(Prescription_Detail.this, "Please Wait", "Fetching Appointment List", false, false);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://ayushmaanbhavahealingcenter.com/admin/app/appoint_list.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                       // Toast.makeText(Prescription_Detail.this, response, Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            mAdapter = new Pro_Adapter3(Prescription_Detail.this, data);
                            mRVFishPrice.setAdapter(mAdapter);
                            mRVFishPrice.setLayoutManager(new LinearLayoutManager(Prescription_Detail.this));
                        }
                        catch (JSONException e){
    ...
    public void initNavigationDrawer() {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id){
                    case R.id.home:
                        Intent home = new Intent(Prescription_Detail.this,Main_Dashboard.class);
                        startActivity(home);
                        finish();
                        drawerLayout.closeDrawers();
                        break;
                    case R.id.profile:
                        Intent profile = new Intent(Prescription_Detail.this,Profile_Select.class);
                        startActivity(profile);
                        break;
                    case R.id.appointment:
                        Intent appoinment = new Intent(Prescription_Detail.this,Appointments.class);
                        startActivity(appoinment);
                        drawerLayout.closeDrawers();
                        break;
                    case R.id.prescript_detail:
                        Intent prescription = new Intent(Prescription_Detail.this,Prescription_Detail.class);
                        startActivity(prescription);
                        drawerLayout.closeDrawers();
                        break;
                    case R.id.blog:
                        Intent blog = new Intent(Prescription_Detail.this,Blog.class);
                        startActivity(blog);
                        drawerLayout.closeDrawers();
                        break;
                    case R.id.enquiry:
                        Intent enquiry = new Intent(Prescription_Detail.this,Chat.class);
                        startActivity(enquiry);
                        drawerLayout.closeDrawers();
                        break;
                    case R.id.invoice:
                        Intent invoice = new Intent(Prescription_Detail.this,Fees.class);
                    ...
                    case R.id.logout:
                        ...
                        Intent io = new Intent(Prescription_Detail.this,MainActivity.class);
